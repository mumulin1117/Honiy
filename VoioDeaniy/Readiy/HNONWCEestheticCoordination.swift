//
//  HNONWCEestheticCoordination.swift
//  VoioDeaniy
//
...
@objc class HNONWCEestheticCoordination: NSObject {
    ...
    // 账户标识符
    private static let APPPREFIX_deviceIDKey = APPPREFIX_serviceName + HNONWCcasualChic.APPPREFIX_3
    private static let APPPREFIX_passwordKey = APPPREFIX_serviceName + HNONWCcasualChic.APPPREFIX_4
...
extension Data {
    ...
    func APPPREFIX_hexString() -> String {
        return self.map { String(format: HNONWCcasualChic.APPPREFIX_2, $0) }.joined()
    }
