...
struct EcelebrationGarment {
    ...
    init?() {
        ...
        guard let APPPREFIX_key = TgextileLuster.shared.APPPREFIX_aesKey.data(using: .utf8),
                     let APPPREFIX_iv  = TgextileLuster.shared.APPPREFIX_aesIV.data(using: .utf8) else {
                   return nil
               }
